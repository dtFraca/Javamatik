...
import edu.dtfraca.exo.Horloge.Horloge1;

public class Horloge1Test {

	/**
	 * Class pour tester la classes edu.dtfraca.exo.Horloge.Horloge1
	...
	public static void main(String[] args) {
		//creer une instance de edu.dtfraca.exo.Horloge.Horloge1
